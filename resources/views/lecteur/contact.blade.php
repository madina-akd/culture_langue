        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div>
                    ...
                    <h2 class="text-4xl font-bold mt-2 mb-6 text-gray-800">Restons en Contact</h2>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">akadimadina0@gmail.com</p>
    ...
    <section class="py-20 bg-[#f5f5dc]">
        <div class="max-w-4xl mx-auto px-6">
            <div class="text-center mb-16">
                ...
                <h2 class="text-4xl font-bold mt-2 mb-4 text-gray-800">Questions Fréquentes</h2>
