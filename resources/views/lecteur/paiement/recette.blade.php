    ...
    <div class="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl">
        <div class="p-8">
            ...
            <div class="text-center mb-6">
                <h2 class="text-2xl font-bold text-amber-800">Accéder à la recette complète</h2>
            ...
            <div class="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6">
                <div class="flex items-center justify-between">
                    ...
                    <span class="text-2xl font-bold text-amber-700">{{ number_format(env('FEDAPAY_PRICE_RECETTE', 300), 0, ',', ' ') }} FCFA</span>
                </div>
            ...
            <form action="{{ route('paiement.recette.process', $contenu->id) }}" method="POST" id="payment-form">
                @csrf
